...
import {api} from "../utils/mkReq.js";
...
export const Revenue = () => {
    ...
    const handleSubmit = async (e) => {
        ...
        setIsLoading(true);
        try {
            const response = await axios.post(`${api.baseUrl}/capture/revenue`, newExpenseEntry, {
                headers: {
                ...
                <div className="relative inset-0 flex items-center justify-center">
                    {isOnline ? (
                        <div className="bg-white p-6 rounded-lg absolute top-7 w-2/5 ">
                            <p className="text-sm font-semibold mb-4"> <FontAwesomeIcon icon={faCheck} className="mr-1 text-white text-lg bg-green-500  rounded-xl" /> revenue recorded </p>
                        ...
                        <div className="lg:flex sm:block">
                            ...
                            <div>
                                ...
                                ">
                                    ...
                                    <option> AMC Income </option>
                                    <option> Appeals Fund Income </option>
                                    <option> Bookshop/Sacramental Store Income </option>
                                    <option> Building Fund Income/Launching </option>
                                    <option> Chapel/Grotto Boxes Income </option>
                                    <option> Church Offertory/Baptism/Wedding/Funeral/Sacraments Income </option>
                                    <option> Church Offertory Income/Sundays</option>
                                    <option> Church Offertory Income/Weekdays </option>
                                    <option> Donations/Gifts </option>
                                    <option> Harvest Income </option>
                                    <option> Harvest Redemption/Pledge Income </option>
                                    <option> Investment Income </option>
                                    <option> Loans Income </option>
                                    <option> Mandatory Collection Income </option>
                                    <option> Mass Intentions Income </option>
                                    <option> Out-Stations Income </option>
                                    <option> Parish Crusade/ Adoration/Retreat/Revival </option>
                                    <option> Parish Registration Income </option>
                                    <option> Rentals Income </option>
                                    <option> Sacrament of Confirmation Income </option>
                                    <option> Sales/Bulletin, Newspaper/Fixed Assets/ Mass Wine Income </option>
                                    <option> Special Project Income </option>
                                    <option> Store Fees/Sacraments Celebrated except Confirmation Income </option>
                                    <option> Thanksgiving Income </option>
                                    <option> Tithe Income </option>
                                </select>
